...
TWRP_QSEECOMD="$arrow_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/qseecomd
TWRP_GATEKEEPER_SERVICE="$arrow_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/android.hardware.gatekeeper@1.0-service-qti
TWRP_KEYMASTER_SERVICE="$arrow_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/recovery/root/sbin/android.hardware.keymaster@3.0-service-qti
...
DEVICE_ROOT="$arrow_ROOT"/vendor/"$VENDOR"/"$DEVICE"/proprietary/
